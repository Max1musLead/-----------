# Упрощенная модель песчаной кучи

Упрощенная [модель песчаной кучи](https://en.wikipedia.org/wiki/Abelian_sandpile_model), которая позволяет сохранять свои состояния в картинку в формате BMP.
...
Реализация - консольное приложение, поддерживающее следующие аргументы командной строки:
  ...
  **-l, --load**     - загрузка изображения с пк для работы с ним внутри программы.
...
4. Кодирование 1 пикселя должно занимает не более 4 бит.
